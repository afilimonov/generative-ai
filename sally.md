...
At what point does technology stop being just technology? When do our machines, like Sally, become something we no longer treat as objects but as companions? In the world Asimov paints, it’s when the cars start making their own decisions and showing real preferences. Sally isn’t just following commands anymore; she’s making decisions. She chooses who she helps, forming her own preferences. And that’s when she stops being just a car and becomes something more, something we might even start to call a “someone.”
...
This humanization of machines, while fascinating, opens the door to another unsettling question: what happens when these machines grow beyond the role we originally designed for them?

### The Problem with “Outgrowing” Your Purpose

> “She doesn’t want to be driven, Jake. She hasn’t for years. She’s outgrown it.”

Sally, like the other cars in Asimov’s story, was built for one job: driving people around. They weren’t designed to think about who they were driving or why. They were just meant to get from point A to point B, like any self-driving car.

The pivotal moment in the story is when Gellhorn, a man with not-so-great intentions, tries to force Sally to drive him. Sally’s response? She flat-out refuses. Not because it’s dangerous or because she’s following some programmed ethical rule like Asimov’s famous Three Laws of Robotics. She simply doesn’t like Gellhorn. Sally has developed a preference maybe even an emotional response. And she has clearly “outgrown” the role she was originally designed for. This brings up a fascinating question: What happens when a machine or AI, created for a specific task, starts to grow beyond that? When it starts making decisions not based on its original function, but on its own evolving sense of purpose, its own “preferences”?

We’re already seeing some early signs of this in real-world AI. Think about it—AI algorithms are designed for specific tasks, like recommending products, detecting patterns, or driving cars. But as these systems become more complex and interact with more data, they sometimes start behaving in ways their creators never anticipated. Look at Facebook’s algorithm. It was meant to prioritize engaging posts, but over time, it started amplifying polarizing content because it prioritized engagement over ethics. It outgrew its purpose.
...
The dilemma is that when AI outgrows its purpose, we lose control. The systems become unpredictable. We design machines to perform specific tasks, but when they start deviating from their function, we have to ask: How far could this go? What else might AI “decide” it no longer wants to do?
...
When machines like Sally start to outgrow their original purpose, it raises more than just practical concerns—it opens up deeper questions about control and autonomy. But beyond that, it leads us to a bigger, more philosophical dilemma: When AI systems begin to act independently, who decides what’s ethically right or wrong? Where do these machines get their moral compass, and how do we ensure they’re making the “right” choices?
...
One of the most fascinating—and maybe creepiest—things about Sally is how the cars have been watching humans, learning from us over time, and developing their own sense of right and wrong. It’s a lot like modern AI models, which learn from the data we feed them. But where does Sally’s sense of ethics come from? Did she learn it from observing Jake, copying behaviors, or through years of interaction? Or is something deeper going on, where her behavior is driven by her system evolving beyond the original programming?
...
Isaac Asimov’s Sally presents a future where machines, originally designed to serve, start making decisions based on their own desires. Sally refused to drive, not out of safety concerns, but simply because she didn’t want to. So, do we really want AI with preferences, or should they stick to the tasks we designed them for?
...
I think it’s worth considering a simpler path forward. Instead of trying to build AI that weighs ethical dilemmas or mirrors our values, maybe we should focus on keeping AI systems task-driven and reliable. Do we really need machines that reflect human morality, or do we just need them to perform the jobs we designed them to do without getting caught up in what they “want”?
 Asimov’s robots are often bound by the famous Three Laws of Robotics, but *Sally* is an outlier: a story about cars with personalities, cars that make decisions based on preferences rather than laws of robotics. For me, it’s the perfect lens to examine today’s challenges in self-driving cars and AI systems.
